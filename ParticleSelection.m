function [Pparticles] = ParticleSelection(Img, r, SelectionCriteria,verbose)
    ...
    for i = 1:Ncriteria
        Property = SelectionCriteria.Property;                          % Region property to check
        Value = SelectionCriteria.Value;                                % Value to check the property against
        Criteria = SelectionCriteria.Criteria;                          % Criteria to be a valid particle (either 'greater' or 'smaller')
    ...
    % object is centered around (r,r), to limit edge effects, but this
